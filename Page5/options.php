...
$query = "select * from travelmanagement.busroutes where source = '$source' and destination = '$destination'";
...
if($total!=0)
{
	...
	while ($result = mysqli_fetch_assoc($data)) 
	{
		...
		<td>".$result['cost']."</td>
		<td><a href='final.php?bno=$result[BusNumber]'>Book</td>
		</tr>
...
{
	echo "<tr><th colspan='6'>Sorry, No Buses Available</th></tr>";
}
